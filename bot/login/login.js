...
try {
        ...
        console.log("⚠️  Canvas not available - QR code features disabled");
}
...
if (!Canvas) {
        throw new Error("Canvas module not available - cannot read QR codes. Use appstate login instead.");
}
